...
#        control_title = tk.Label(control_section, text="CONTROLES", font=("Inter", 10, "bold"), 
#                                fg="#333", bg="#f0f0f0")
#        control_title.pack(pady=2)
        ...
        #stats_title = tk.Label(stats_section, text="ESTADÍSTICAS", font=("Inter", 10, "bold"), 
        #                      fg="#333", bg="#f0f0f0")
        #stats_title.pack(pady=1)
